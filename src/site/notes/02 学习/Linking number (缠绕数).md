---
{"dg-publish":true,"dg-permalink":"linking-number","permalink":"/linking-number/","title":"Linking number (缠绕数)","tags":["math/topology","knot-theory","concept/invariant","paper/nikkuni"]}
---
...
> [!image]- 符号规则
> ![[linking number.png\|linking number.png]]
...
基于代数拓扑的同调定义，常见于理论推导。[[02 学习/Linking Number via Seifert Surface\|定义解释]]
