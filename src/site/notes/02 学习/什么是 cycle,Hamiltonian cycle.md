---
{"dg-publish":true,"permalink":"/02/cycle-hamiltonian-cycle/","title":"什么是 cycle,Hamiltonian cycle","tags":["math/graph-theory","math/topology"]}
---
...
在理解 Nikkuni 的论文前，需明确图 $G=(V, E)$ 中的路径结构。
...
> [!image]+ 图片说明 
> ![[Pasted image 20260117135534.png\|Pasted image 20260117135534.png]]
...
> 2. **必要条件**: 若图 $G$ 有 Hamiltonian Cycle，则 $G$ 必须是连通的（Connected）且没有割边（Bridge）。[[02 学习/Hamiltonian Cycle 必要条件解释\|Hamiltonian Cycle 必要条件解释]]
> 3. **计算复杂度**: 一般图中寻找 Hamiltonian Cycle 是 **NP-complete** 问题。

> [!image]+ 图片说明
> ![[Petersen Graph.png\|331]]![[Pasted image 20260117140421.png\|539]]
