---
{"dg-publish":true,"dg-permalink":"topological-invariants","permalink":"/topological-invariants/","title":"Topological Invariants-Linking Number & Arf Invariant","tags":["math/topology","knot-theory","concept/invariant","paper/conway-gordon","paper/adams-knot-book"]}
---


在 Conway-Gordon-Sachs 定理及 Nikkuni 的研究中，主要使用两类 $\mathbb{Z}_2$ (Mod 2) 不变量来探测空间图的复杂性。
...
*   **Adams, C. C. (2004).** *The Knot Book*. (Section on Arf Invariant).
    *   *Note*: Adams 书中通常通过 Seifert Matrix 或 Alexander Polynomial 的系数来计算 Arf。
*   **Conway, J. H., & Gordon, C. M. (1983).**
    *   定义了基于 Seifert form 的 Arf 不变量用于 $K_7$ 的证明。