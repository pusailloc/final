---
{"dg-publish":true,"dg-permalink":"conway-gordon-sachs-theorem","permalink":"/conway-gordon-sachs-theorem/","title":"Conway-Gordon-Sachs 定理","tags":["math/spatial-graph-theory","concept/theorem","paper/conway-gordon"]}
---
...
> [!image]- $K_6$ 示意图
> ![[Pasted image 20260117161212.png\|327]]
>存在互锁的一对三角形
...
## 3. 关键逻辑解析 (Key Competencies)

理解该定理证明思路的三个关键点：

### A. 为什么选择三角形对 (Triangle Pairs)?
针对 $K_6$ ($|V|=6$)：
...
## 4. 参考文献
*   **Conway, J. H., & Gordon, C. M. (1983).** *Knots and links in spatial graphs*. Journal of Graph Theory.
*   **Sachs, H. (1983).** *On spatial representations of finite graphs*.
