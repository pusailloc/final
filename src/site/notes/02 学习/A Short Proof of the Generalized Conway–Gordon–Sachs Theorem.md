---
{"dg-publish":true,"dg-permalink":"conway-gordon-sachs-proof","permalink":"/conway-gordon-sachs-proof/","title":"A Short Proof of the Generalized Conway–Gordon–Sachs Theorem","tags":["paper/nikkuni","math/spatial-graph-theory","study-note"]}
---
...
*   **空间对象**:
    ...
    *   **Hamiltonian link**: 包含图 $G$ **所有** 顶点的 Link。
        *   *助教注解*: 在 $p+q=n$ 的语境下，一个 $(p,q)$-link 必然覆盖了所有 $n$ 个顶点，因此它是一个 (2-component) Hamiltonian link。
...
### 助教结语
你现在不仅掌握了一个定理，更掌握了一套空间图论的标准研究范式：
**Combinatorics (计数/归纳) + Topology (同调/不变量) = Deep Structure of Spatial Graphs.**
